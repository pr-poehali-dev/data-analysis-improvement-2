  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Тело,
          <span className="block text-sage">о котором вы мечтали</span>
        </h1>
        ...
        >
          Научный подход к снижению веса без жёстких диет и изнурительных тренировок. Реальные результаты уже через 4 недели.
        </p>
